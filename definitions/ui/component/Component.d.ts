...
export default class Component<E extends HTMLElement = HTMLElement> extends EventEmitter.Host<Events<IComponent>> implements IComponent {
    ...
    static get(element: Element | null | false | undefined): Component | undefined;
    static get(selector: string, create: false | undefined): Component | undefined;
    static get(element: Element, create: false | undefined): Component | undefined;
    static get(event: Event, create: false | undefined): Component | undefined;
    static get(element: Element | null | false | undefined, create: false | undefined): Component | undefined;
    static get<C extends Component>(selector: string): C | undefined;
    static get<C extends Component>(element: Element): C;
    static get<C extends Component>(event: Event): C;
    static get<C extends Component>(element: Element | null | false | undefined): C | undefined;
    static get<C extends Component>(selector: string, create: false | undefined): C | undefined;
    static get<C extends Component>(element: Element, create: false | undefined): C | undefined;
    static get<C extends Component>(event: Event, create: false | undefined): C | undefined;
    static get<C extends Component>(element: Element | null | false | undefined, create: false | undefined): C | undefined;
