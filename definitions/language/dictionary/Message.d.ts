...
declare enum Message {
    ...
    TradeBarterCreditForItem = 696,
    TradeItemForBarterCredit = 697,
    TradingWith = 698,
    TrampledFire = 699,
    ...
    UnlockedChest = 717,
    UnlockedTime = 718,
    UnpurifiedFreshWater = 719,
    UnpurifiedWaterInStill = 720,
    UsingBareHands = 721,
    Vulnerable = 722,
    WaitUntilFireCooledToGetWater = 723,
    Water = 724,
    WaterGathering = 725,
    WaterPutOutFire = 726,
    Weight = 727,
    ...
    YouDropTheTorch = 751,
    YouEnchant = 752,
    YouEnchantMutate = 753,
    YouEquip = 754,
    YouFailedTo = 755,
    YouFailedToExtinguishedFireFully = 756,
    YouFailedToHeal = 757,
    YouFailedToHealOther = 758,
    YouFire = 759,
    YouGathered = 760,
    YouGatheredAndDropped = 761,
    YouHardenedCooledLava = 762,
    YouHarvested = 763,
    YouHarvestedAndDropped = 764,
    YouHaveAlreadyLearned = 765,
    YouHaveDied = 766,
    YouHaveEnabledDisabled = 767,
    YouHaveHealedOther = 768,
    YouHaveKilled = 769,
    YouHaveReleased = 770,
    YouHaveTamed = 771,
    YouNeedMoreCredit = 772,
    YouNoticeBecomeEnraged = 773,
    YouNoticeDying = 774,
    YouNoticeFertilityDecreasing = 775,
    YouNoticeFertilityIncreasing = 776,
    YouNoticeGrowing = 777,
    YouNoticeLavaCooling = 778,
    YouNoticeLavaHardening = 779,
    YouNoticePerish = 780,
    YouNoticeStumbleInjureItself = 781,
    YouNoticeTakeFromGround = 782,
    YouNoticeWoundsClosing = 783,
    YouNoticeZombieHorde = 784,
    YouOfferedToCreature = 785,
    YouOpen = 786,
    YouPacked = 787,
    YouPickedUp = 788,
    YouRefine = 789,
    ...
    YourInventory = 795,
    YourLowSkill = 796,
    YourModerateSkill = 797,
    YourRubbingNoEffect = 798,
    YouRub = 799,
    YouSalvaged = 800,
    YouSee = 801,
    YouSeeAnAberrant = 802,
    YouSeeASlimeCombine = 803,
    YouSeeDrop = 804,
