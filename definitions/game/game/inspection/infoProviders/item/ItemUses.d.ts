...
export default class ItemUses extends Uses<Item> {
    ...
    }, Item> | import("../UseInfo").default<import("../UseInfo").IUseInfoBase<Item, ActionType.StartFire | ActionType.Ignite | ActionType.Equip>, ActionType.StartFire | ActionType.Ignite | ActionType.Equip, {}, Item> | import("../UseInfo").default<{
        attack: number;
        objectType: CreationId.Item;
        value?: Item | undefined;
        type: ItemType;
