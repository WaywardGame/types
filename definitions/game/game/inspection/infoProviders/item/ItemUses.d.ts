...
export default class ItemUses extends Uses<Item> {
    ...
    protected getUseInfoHandlers(): (import("../UseInfo").default<{
        ...
        details: Set<symbol>;
    }, ActionType.Build, {}, Item> | import("../UseInfo").default<import("../UseInfo").IUseInfoBase<Item, ActionType.Throw>, ActionType.Throw, {}, Item> | import("../UseInfo").default<{
        telescopy: number;
        objectType: CreationId.Item;
        value?: Item | undefined;
        type: ItemType;
        ...
        details: Set<symbol>;
    }, ActionType.StokeFire, {}, Item> | import("../UseInfo").default<import("../UseInfo").IUseInfoBase<Item, ActionType.StartFire | ActionType.Ignite | ActionType.Equip>, ActionType.StartFire | ActionType.Ignite | ActionType.Equip, {}, Item>)[];
}
