...
export default class ItemInspection extends Inspection<ItemType> {
    ...
    private getName;
    get(context: InfoProviderContext): import("../../../language/impl/TranslationImpl").default | (import("../../../language/impl/TranslationImpl").default | import("game/inspection/InfoProvider").SimpleInfoProvider | LabelledValue | QualityInfoProvider | MagicalPropertiesInfoProvider | ItemProtectedInfoProvider | ItemWorthInfoProvider | ItemDurabilityInfoProvider | ItemWeightInfoProvider | ItemDetailsInfoProvider | ItemUses | DoodadUses)[];
