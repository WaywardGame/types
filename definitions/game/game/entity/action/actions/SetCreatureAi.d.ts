...
declare const _default: Action<[[ActionArgument.ItemInventory, ActionArgument.Undefined], import("../argument/ActionArgumentEnum").default<AiType, "Neutral" | "Attack" | "Tamed" | "Random" | "Hostile" | "Scared" | "Hidden" | "Fearless" | "FollowClose" | "Retaliate" | "Fleeing" | "Waiting" | "FollowFar" | "Stay" | "AttackAdjacent" | "AttackInSight" | "Defend" | "Heel">], Human<number, import("../../../reference/IReferenceManager").ReferenceType.NPC | import("../../../reference/IReferenceManager").ReferenceType.Player>, void, ISetCreatureAiCanUse, [import("../../../item/Item").default | undefined, AiType]>;
