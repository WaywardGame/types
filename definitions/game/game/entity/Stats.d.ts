...
import { IStatChangeInfo, StatChangeReason } from "game/entity/IEntity";
import type { IStat, IStatBase, IStatEvents, IStats } from "game/entity/IStats";
import { Stat } from "game/entity/IStats";
import StatFactory, { StatChangeTimerFactory } from "game/entity/StatFactory";
...
export default class Stats<T extends IStatHost> {
    ...
    getTimeUntilChange(stat: Stat | IStat, allowFailure?: boolean): number | undefined;
