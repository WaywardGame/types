...
declare enum Message {
    ...
    ActionConsecrateNoRunes = 110,
    ActionConsecrateRunesConsecrated = 111,
    ActionConsecrateRunesConsecratedNothingUpgraded = 112,
    ActionConsecrateRunesConsecratedChaos = 113,
    ActionConsecrateRunesConsecratedEvil = 114,
    ActionConsecrateRunesConsecratedGood = 115,
