...
declare enum Message {
    ...
    ActionMoveItemCannotUseItemFilteredOut = 68,
    ActionMoveItemCannotUseItemQualityOrTypeIncorrect = 69,
    ActionMoveItemCannotUseItemTooFarAway = 70,
    ActionMoveItemCannotUseMovingFromMultipleContainers = 71,
    ActionMoveItemCannotUseNoContainerToMoveTo = 72,
    ActionMoveItemCannotUseNoItems = 73,
    ActionMoveItemCannotUseNoRoom = 74,
    ActionMoveItemCannotUseProtected = 75,
    ActionMoveToSwimOffEdgeCannotCombatTides = 76,
    ActionNavigateMoon = 77,
    ActionNavigateNotOverworld = 78,
    ActionNavigateSun = 79,
    ActionNavigateUseSextant = 80,
    ActionPetCreatureRefused = 81,
    ActionPetNoTamedCreature = 82,
    ActionPickUpAllItemsNoItems = 83,
    ActionPickUpDoodadCannotUseItemsPlacedOn = 84,
    ActionPickUpExcrementNoExcrement = 85,
    ActionPickUpItemNoItem = 86,
    ActionPickUpNoPickUp = 87,
    ActionPourNoEffect = 88,
