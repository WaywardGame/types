...
export declare enum RenderSource {
    ...
    ParticleSpawn = 35,
    PlayerAdd = 36,
    PlayerAttackAnimationStart = 37,
    PlayerKill = 38,
    PlayerProcessMovement = 39,
    PlayerReady = 40,
    PlayerRemove = 41,
    PlayerRespawn = 42,
    PlayerRest = 43,
    PlayerRestStart = 44,
    PlayerRestStop = 45,
    PlayerWalkToTilePath = 46,
    PlayerWalkToTilePathOverburdened = 47,
    PlayerWalkToTilePathPreview = 48,
    PlayerWalkToTilePathReset = 49,
    RemoveBlood = 50,
    Resize = 51,
    SetupGl = 52,
    StartGame = 53,
