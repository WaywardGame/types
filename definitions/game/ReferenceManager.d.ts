...
export default class ReferenceManager {
    ...
    static getList(type: ReferenceType, gameIsland?: Island): Player[] | readonly SkillType[] | SaferArray<Item> | SaferArray<Corpse> | SaferArray<Creature> | SaferArray<Doodad> | SaferArray<NPC> | SaferArray<TileEvent> | IterableIterator<Island>;
