...
declare enum Bindable {
    ...
    GameActionItemDropAllOfSameQuality = 152,
    GameActionItemDropAllExceptQuality = 153,
    GameActionItemMove = 154,
    GameActionItemMoveAll = 155,
    GameActionItemMoveAllOfSameQuality = 156,
    GameActionItemMoveAllExceptQuality = 157,
