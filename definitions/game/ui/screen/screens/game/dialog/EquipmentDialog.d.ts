...
export declare namespace EquipmentClasses {
    const SlotType: (enumValue: EquipType) => `${"game-dialog-equipment-slot"}-${Lowercase<("None" | "Held" | "Legs" | "Chest" | "Head" | "Waist" | "Feet" | "Neck" | "Hands" | "Back" | "MainHand" | "OffHand" | "DualWield") & string>}`;
}
