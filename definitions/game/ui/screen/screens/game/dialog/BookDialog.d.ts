...
export default class BookDialog extends Dialog {
    ...
    constructor();
    getName(): import("../../../../../language/dictionary/UiTranslation").default | import("../../../../../language/impl/TranslationImpl").default | import("../../../../../language/ITranslation").ISerializedTranslation | Iterable<import("../../../../../utilities/string/Interpolator").IStringSection> | undefined;
