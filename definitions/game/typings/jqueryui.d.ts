...
declare global {
    namespace JQueryUI {
        ...
        type AccordionEvent = (event: Event, ui: AccordionUIParams) => void;
        ...
        type AutocompleteEvent = (event: Event, ui: AutocompleteUIParams) => void;
        ...
        type DialogEvent = (event: Event | null, ui: DialogUIParams | null) => void;
        ...
        type DraggableEvent = (event: Event, ui: DraggableEventUIParams) => void;
        ...
        type DroppableEvent = (event: Event, ui: DroppableEventUIParam) => void;
        ...
        type MenuEvent = (event: Event, ui: MenuUIParams) => void;
        ...
        type ProgressbarEvent = (event: Event, ui: ProgressbarUIParams) => void;
        ...
        type ResizableEvent = (event: Event, ui: ResizableUIParams) => void;
        ...
        type SliderEvent = (event: Event, ui: SliderUIParams) => void;
        ...
        type SortableEvent = (event: JQueryEventObject, ui: SortableUIParams) => void;
        ...
        type SpinnerEvent<T> = (event: Event, ui: T) => void;
        ...
        type TabsEvent<UI> = (event: Event, ui: UI) => void;
        ...
        type TooltipEvent = (event: Event, ui: TooltipUIParams) => void;
