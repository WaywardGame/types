...
export default class HashSet<T> {
    ...
    keyStream(): import("@wayward/goodstream").default<string>;
    valueStream(): import("@wayward/goodstream").default<T>;
    entryStream(): T extends T ? import("@wayward/goodstream").default<[string, T]> : never;
