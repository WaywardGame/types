...
export default class ReferenceManager {
    ...
    static getList(type: ReferenceType, gameIsland?: Island): Player[] | SaferArray<Item> | SaferArray<Corpse> | SaferArray<Creature> | SaferArray<Doodad> | SaferArray<NPC> | SaferArray<TileEvent> | readonly SkillType[] | IterableIterator<Island>;
