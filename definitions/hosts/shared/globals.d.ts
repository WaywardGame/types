 ...
 */
export declare const gameVersionStage = "beta", gameVersionMajor = 2, gameVersionMinor = 14, gameVersionPatch = 0, gameVersionName = "Next";
export declare const gameVersion = "beta2.14.0";
export declare const gameVersionTitleMajor = "Wayward: Next";
