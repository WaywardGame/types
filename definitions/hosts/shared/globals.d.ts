...
export declare const gameVersionStage = "beta", gameVersionMajor = 2, gameVersionMinor = 14, gameVersionPatch = 6, gameVersionName = "Runekeeper", gameVersionColor = 11015763;
export declare const gameVersion = "beta2.14.6";
