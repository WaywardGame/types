...
export declare class Quest extends EventEmitter.Host<IQuestEvents> {
    ...
    getHostTriggers(instance: IQuest): import("@wayward/goodstream/Stream").default<[IQuestRequirement<any[], {}>, IterableIterator<["statChanged" | "statusChange" | "created" | "removed" | "preMove" | "postMove" | "statTimerChanged" | "statTimerWillChange" | "statTimerRemoved" | "statMaxChanged" | "statBonusChanged" | "tickStart" | "tickEnd" | "spawn" | "restored" | "updateOption" | "displayMessage" | "interruptResponse" | "getMaxHealth" | "getMaxWeight" | "damage" | "shouldDie" | "die" | "shouldRespawn" | "respawn" | "inventoryItemAdd" | "inventoryItemRemove" | "inventoryItemUpdate" | "processMovement" | "getMovementIntent" | "noInput" | "walkPathChange" | "moveComplete" | "changeZ" | "getWeightStatus" | "getWeightOrStaminaMovementPenalty" | "restStart" | "restEnd" | "writeNote" | "writtenNote" | "readNote" | "skillChange" | "canConsumeItem" | "canDropItem" | "canAttack" | "calculateEquipmentStats" | "isSwimming", (api: IQuestRequirementApi<[], {}>, player: Player, ...args: any[]) => boolean]>]>;
