...
export declare class QuestRequirement<O extends any[] = [], D extends {} = {}> {
    ...
    getHostTriggers(): IterableIterator<["tickStart" | "tickEnd" | "spawn" | "updateOption" | "displayMessage" | "getMaxHealth" | "getMaxWeight" | "damage" | "shouldDie" | "die" | "shouldRespawn" | "respawn" | "inventoryItemAdd" | "inventoryItemRemove" | "inventoryItemUpdate" | "processMovement" | "getMovementIntent" | "noInput" | "walkPathChange" | "moveComplete" | "changeZ" | "getWeightStatus" | "getWeightOrStaminaMovementPenalty" | "restStart" | "restEnd" | "skillChange" | "canConsumeItem" | "canDropItem" | "canAttack" | "calculateEquipmentStats" | "isSwimming" | "statusChange" | "removed" | "preMove" | "postMove" | "statChanged" | "statTimerChanged" | "statTimerWillChange" | "statTimerRemoved" | "statMaxChanged" | "statBonusChanged", (api: IQuestRequirementApi<O, D>, player: Player, ...args: any[]) => boolean]>;
