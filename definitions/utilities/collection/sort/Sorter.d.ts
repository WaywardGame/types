 ...
 */
type EntryMapper<T = any, A extends any[] = any[]> = (v: T, ...args: A) => string | number;
export interface ISorter<T> {
     ...
     */
    addFallback<A extends any[]>(fallback: EntryMapper<T, A>, ...args: A): this;
    /**
     * Sets a reversed fallback entry mapper for sorting for when two items are in the same position
     */
    addFallback<A extends any[]>(reverse: true, fallback: EntryMapper<T, A>, ...args: A): this;
    /**
...
export default function <T, A extends any[]>(reverse: boolean, mapper?: EntryMapper<T, A>, ...args: A): ISorter<T>;
export default function <T, A extends any[]>(mapper?: EntryMapper<T, A>, ...args: A): ISorter<T>;
export {};
